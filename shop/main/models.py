...
class Product(models.Model):
    ...
    discription = models.TextField(null=False, blank=True, verbose_name='Описание товара')
...
class Category(models.Model):
    category_id = models.IntegerField()
    name = models.CharField(max_length=200, verbose_name='Название')
    discription = models.TextField(default='discription', verbose_name='Описание категории')
